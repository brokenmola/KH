<%-- 보내는 사람 smtp 서버 주소를 설정한 네이버의 "아이디@naver.com"으로 합니다. --%>
<%@ page language="java" contentType="text/html; charset=euc-kr"
    pageEncoding="euc-kr"%>
    <%@ page import="java.util.*" %>
<%-- 자바 메일 API를 사용하기 위해 관련 패키지를 import한다. --%>
...
<%
	...
	try{
		...
		//첫번째 인자는 연결할 호스트 입니다.
		//두번재 인자는 아이디, 세번재 인자는 비밀번호를 의미합니다.
		...
		out.println("SMTP 서버가 잘못 설정되었거나, 서비스에 문제가 생겼습니다.");
		e.printStackTrace();
	}
%>